...
namespace Renderer {
	...
	public:
		...
		OGL33ShaderAttribute(const IShader& shader, const char* name, unsigned int index, unsigned int size, ShaderAttributeType type, bool isArray, unsigned int length);
	public:
