...
namespace Renderer {
	...
	protected:
		...
		inline IBufferView(const IBufferData& data, unsigned int numComponents = 1, BufferDataType type = BufferDataType::Float, unsigned int strideInBytes = 0, unsigned int offsetInBytes = 0) { }
	public:
